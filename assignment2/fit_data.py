...
import torch
from visualization import draw_voxel, draw_pointcloud, draw_mesh
...
def train_model(args):
    ...
    if args.type == "vox":
        ...
        draw_voxel(voxels_tgt,  thresh=0.5, save_as="out/vox_tgt.png")
        draw_voxel(voxels_src, thresh=0.5, save_as="out/vox_src.png")
        ...
        draw_pointcloud(pointclouds_tgt,  save_as="out/pc_tgt.png",  dot_size=2)
        draw_pointcloud(pointclouds_src, save_as="out/pc_src.png", dot_size=2)        
